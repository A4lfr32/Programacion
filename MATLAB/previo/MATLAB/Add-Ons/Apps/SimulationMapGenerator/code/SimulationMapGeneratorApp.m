classdef SimulationMapGeneratorApp < handle
    %
    % Usage:
    %     app.SimulationMapGeneratorApp
    ...
    properties (Constant)
        AppPathBase = {'/SimulationMapGenerator/code'};
        AppClass = 'SimulationMapGeneratorApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = SimulationMapGeneratorApp()
        ...
        function startApp(obj)
            ...
            mlock;
            SimulationMapGeneratorApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'simMapGenerator')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong simMapGenerator
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'simMapGenerator').getString, ...
            ...
            if nargout(@simMapGenerator) == 0
                eval('simMapGenerator');
            else
                obj.AppHandle = eval('simMapGenerator');
            end
